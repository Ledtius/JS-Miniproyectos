...
function createListElements(inputValue) {
  ...
  $listElement.classList.add("todo-list__element");

  /* 1 area */
  const $checkTask = document.createElement("div");
  $checkTask.classList.add("todo-list__check-task");
  ...
  $option2.classList.add("todo-list__option");
  $option2.innerHTML = `<svg
  ...
  /* 2 area */
  $listElement.appendChild($editDelete);
  $editDelete.appendChild($option1);
